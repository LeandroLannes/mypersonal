...
export default function App() {
        ...
        if (regs) {
          ...
          regs.forEach(r => {
            ...
            mapa[`reg:${dataStr}`] = {
              ...
              concluido: dataStr === hoje ? r.concluido : false,
              diaKey: r.dia_key,
              data: dataStr,
            };
          });
  ...
  // Proteção final: se a data não bater com hoje, trata como vazio
  const regHoje = (regRaw.data && String(regRaw.data).slice(0,10) === hoje) ? regRaw : {};
